...
public class Dice20 {
    ...
    public View getImg() {
        if(this.img == null ){
            ...
            setRefreshImg();
            if (aquene.getAllResources().getResource("resource_mythic_points") != null && aquene.getAllResources().getResource("resource_mythic_points").getMax() > 0) {
    ...
    private void setRefreshMythicSurge() {
        this.img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (canBeLegendarySurge && aquene.getAllResources().getResource("resource_legendary_points") != null && aquene.getAllResources().getResource("resource_legendary_points").getMax() > 0) {
    ...
    private void launchingMythicDice(String mode) {
        ...
        if (mode.equalsIgnoreCase("légendaire")) {
            points = aquene.getCurrentResourceValue("resource_legendary_points");
        } else {
            points = aquene.getCurrentResourceValue("resource_mythic_points");
        }
